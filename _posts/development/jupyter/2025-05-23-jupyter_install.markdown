...
categories: 
  ...
  - jupyter
image : 
  path : /assets/img/blog/development/jupyter/250523_jupyter_install/thumbnail.jpg
---
...
![](/assets/img/blog/development/jupyter/250523_jupyter_install/img_01.jpg)
...
![](/assets/img/blog/development/jupyter/250523_jupyter_install/img_02.jpg)
...
![](/assets/img/blog/development/jupyter/250523_jupyter_install/img_03.jpg){: width="80%" height="80%"}
  
Python을 설치해야한다고 가정하고, Python 공식 웹사이트의 [다운로드 페이지](https://www.python.org/downloads/)에서 Python 설치에 필요한 파일을 다운로드합니다.  
  
![](/assets/img/blog/development/jupyter/250523_jupyter_install/img_04.jpg){: width="80%" height="80%"}
...
![](/assets/img/blog/development/jupyter/250523_jupyter_install/img_05.jpg){: width="80%" height="80%"}  
![](/assets/img/blog/development/jupyter/250523_jupyter_install/img_06.jpg){: width="80%" height="80%"}
...
![](/assets/img/blog/development/jupyter/250523_jupyter_install/img_07.jpg){: width="80%" height="80%"}
  
아래와 같이 옵션을 체크하고 설치를 완료합니다.  
  
![](/assets/img/blog/development/jupyter/250523_jupyter_install/img_08.jpg){: width="80%" height="80%"}  
![](/assets/img/blog/development/jupyter/250523_jupyter_install/img_09.jpg){: width="80%" height="80%"}  
![](/assets/img/blog/development/jupyter/250523_jupyter_install/img_10.jpg){: width="80%" height="80%"}  
![](/assets/img/blog/development/jupyter/250523_jupyter_install/img_11.jpg){: width="80%" height="80%"}  
![](/assets/img/blog/development/jupyter/250523_jupyter_install/img_12.jpg){: width="80%" height="80%"}  
![](/assets/img/blog/development/jupyter/250523_jupyter_install/img_13.jpg){: width="80%" height="80%"}  
![](/assets/img/blog/development/jupyter/250523_jupyter_install/img_14.jpg){: width="80%" height="80%"}  
![](/assets/img/blog/development/jupyter/250523_jupyter_install/img_15.jpg){: width="80%" height="80%"}
...
![](/assets/img/blog/development/jupyter/250523_jupyter_install/img_16.jpg){: width="80%" height="80%"}
  
그 다음, 파일을 우클릭 후 속성에 들어가 시작 위치를 지정해야하는데  
쉽게 말해 프로젝트 폴더 경로를 지정하는 과정입니다.  
Jupyter를 실행했을 때, 기본으로 시작되는 경로라 생각해주시면됩니다.  
  
![](/assets/img/blog/development/jupyter/250523_jupyter_install/img_17.jpg){: width="80%" height="80%"}
  
이대로 사용해도 문제는 없지만, 디테일을 살리고 싶으면 아이콘 변경을 해주시면됩니다.  
아이콘 변경 버튼을 클릭 후, Anaconda 설치 경로에 있는 Menu 폴더에 들어가 `jupyter.ico`을 적용해주세요.  
  
![](/assets/img/blog/development/jupyter/250523_jupyter_install/img_18.jpg){: width="80%" height="80%"}
![](/assets/img/blog/development/jupyter/250523_jupyter_install/img_19.jpg){: width="80%" height="80%"}
...
![](/assets/img/blog/development/jupyter/250523_jupyter_install/img_20.jpg){: width="80%" height="80%"}  
![](/assets/img/blog/development/jupyter/250523_jupyter_install/img_21.jpg){: width="80%" height="80%"}